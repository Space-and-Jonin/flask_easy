...
from .exceptions import app_exception_handler, AppExceptionCase, HTTPException
...
class FlaskEasy:
    ...
    def init_app(self, app: Flask):
        ...
        self.register_swagger_definitions(app)

    def register_extensions(self, flask_app):
    ...
    def initialize_databases(self, flask_app):
        app = flask_app
    ...
    def generate_db_url(
        self, engine_prefix, db_host, db_user, db_password, db_port, db_name
    ):  # noqa
    ...
    def register_blueprints(self, app):
        ...
        app.register_blueprint(self.SWAGGERUI_BLUEPRINT, url_prefix=self.SWAGGER_URL)
        api.init_app(app)
        return None

    def register_swagger_definitions(self, app):
    ...
    def easy_url_rule(
        ...
        **options: t.Any,
        ...
        assert view_name, "name of target view is required"

        defaults = options.pop("defaults", {})
        defaults.update({"view_name": view_name})
